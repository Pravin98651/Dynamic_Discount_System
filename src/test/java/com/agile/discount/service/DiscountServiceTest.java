...
public class DiscountServiceTest {
    ...
    public void testRegularDiscount_NoDiscount() {
        ...
        assertEquals(0.0, discountService.calculateDiscountPercentage(request));
        assertEquals(100.0, discountService.calculateFinalPrice(request));
    }
    ...
    public void testNewUser_BlackFriday_Overstocked() {
        ...
        assertEquals(0.35, discountService.calculateDiscountPercentage(request));
        assertEquals(130.0, discountService.calculateFinalPrice(request));
    }
    ...
    public void testLoyalCustomer_LowStock() {
        ...
        assertEquals(0.10, discountService.calculateDiscountPercentage(request));
        assertEquals(45.0, discountService.calculateFinalPrice(request));
    }
